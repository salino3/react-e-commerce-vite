...
export const MoreInfo: React.FC = () => {
  ...
  const product: ProductInfo | undefined = state?.products?.find((item: ProductInfo) => item.id === Number(id));
...
if (product) {
  ...
  return <h1 className="text-center m-2  text-warning">Product Not Found...</h1>;
 }
